...
class CatalogMapperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getCatalog_ArrayWithDuplicateSKUGiven_CatalogExceptionIsThrown()
    {
        ...
        $productMapperMock->method("getProduct")->will($this->onConsecutiveCalls(
            new Product(new SKU("0001"), new Price(Money::EUR(300)), new Slug("product-1"), new Content("Title", "Summary")),
            new Product(new SKU("0002"), new Price(Money::EUR(300)), new Slug("product-2"), new Content("Title", "Summary")),
            new Product(new SKU("0001"), new Price(Money::EUR(300)), new Slug("product-1a"), new Content("Title", "Summary")))
        );
    ...
    public function getCatalog_ArrayWithDuplicateSlugsGiven_CatalogExceptionIsThrown()
    {
        ...
        $productMapperMock->method("getProduct")->will($this->onConsecutiveCalls(
            new Product(new SKU("0001"), new Price(Money::EUR(300)), new Slug("product-1"), new Content("Title", "Summary")),
            new Product(new SKU("0002"), new Price(Money::EUR(300)), new Slug("product-2"), new Content("Title", "Summary")),
            new Product(new SKU("0003"), new Price(Money::EUR(300)), new Slug("product-1"), new Content("Title", "Summary")))
        );
    ...
    public function getCatalog_ArrayWithSimilarSKUsGiven_CatalogExceptionIsThrown()
    {
        ...
        $productMapperMock = $this->createMock(ProductMapper::class);
        $productMapperMock->method("getProduct")->will($this->onConsecutiveCalls(
            new Product(new SKU("product"), new Price(Money::EUR(300)), new Slug("product-a"), new Content("Title", "Summary")),
            new Product(new SKU("product"), new Price(Money::EUR(300)), new Slug("product-b"), new Content("Title", "Summary")))
        );
    ...
    public function getCatalog_ArrayWithSimilarSlugsGiven_CatalogExceptionIsThrown()
    {
        ...
        $productMapperMock = $this->getMockBuilder(ProductMapper::class)->disableOriginalConstructor()->getMock();
        $productMapperMock->method("getProduct")->will($this->onConsecutiveCalls(
            new Product(new SKU("0001"), new Price(Money::EUR(300)), new Slug("a-product"), new Content("Title", "Summary")),
            new Product(new SKU("0002"), new Price(Money::EUR(300)), new Slug("A-Product"), new Content("Title", "Summary")))
        );
